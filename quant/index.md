...
1. System architecture diagram (pipeline flow)  
2. Data flow visualization (ingestion → features → model → backtest)  
3. Example backtest results and metrics  
4. SHAP visualization for model explainability  