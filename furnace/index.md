...
1. A simple block diagram of the furnace system and major process flow  
2. A before/after startup sequence diagram  
3. A root-cause sketch showing the rotary airlock bottleneck and resulting backpressure  
4. A simple table summarizing problem, action, and result